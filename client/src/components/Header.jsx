        ...
        <header className="p-4 bg-gray-100 text-gray-800">
            <div className="container flex justify-between h-16 mx-auto">
                ...
                <ul className="items-stretch hidden space-x-3 md:flex">
                    <li className="flex">
                        <a rel="noopener noreferrer" href="/addrecipe/" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Submit Recipe</a>
                    </li>
                    <li className="flex">
                        <a rel="noopener noreferrer" href="/dedication/" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Dedication</a>
                    </li>
                    {/* <li className="flex">
